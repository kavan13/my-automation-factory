...
public class WomenCategoryPageTest extends TestBase {
    ...
    @Test(groups = {"sanity","regression"}, dataProvider = "womenpagetest1", dataProviderClass = TestData.class)
    ...
    @Test(groups = {"smoke","regression"}, dataProvider = "womenpagetest2", dataProviderClass = TestData.class)
