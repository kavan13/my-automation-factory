...
public class SignInPageTest extends TestBase {
    ...
    @Test(groups = {"sanity","smoke","regression"}, dataProvider = "IdandPassword", dataProviderClass = TestData.class)
    ...
    @Test(groups = {"smoke","sanity","regression"}, dataProvider = "logout", dataProviderClass = TestData.class)
